...
| Persona | Key Message | Proof Point | CTA |
|---------|-------------|-------------|-----|
| [Persona 1] | [Message] | [Evidence] | [Action] |
| [Persona 2] | [Message] | [Evidence] | [Action] |
| [Persona 3] | [Message] | [Evidence] | [Action] |
...
- [ ] Create sales enablement using `/sales-enablement-kit`
- [ ] Create launch checklist using `/launch-checklist`
